...
switch (_traits) do {
    ...
    default {
        systemChat format ["[MF WARNING] Player init module: Invalid unit trait value (%1) of unit (%2)!", _traits, _unit];
        diag_log format ["[MF WARNING] Player init module: Invalid unit trait value (%1) of unit (%2)!", _traits, _unit];
    };
};
